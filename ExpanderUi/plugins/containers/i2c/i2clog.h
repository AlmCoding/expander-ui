...
class I2cLog {
   public:
    ...
    explicit I2cLog(QString time, QString interface_name, I2cTypes::I2cReqestType type, QString name,
                    QString slave_address, QString write_data, QString read_data, QString write_size, QString read_size,
                    QString status);
    ...
    void setReadData(QString read_data) {
    ...
    QString getReadDataAscii() const { return read_data_ascii_; }
